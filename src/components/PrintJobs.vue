    ...
    <v-main class="pa-3">
      ...
      <v-card class="module">
        <module-toolbar
          ...
          title="Print Job Creation"
          icon="mdi-printer"
          @minimize="printJobCreateMinimize = true"
          @maximize="printJobCreateMinimize = false"
        >
        </module-toolbar>
        <print-job-create v-if="!printJobCreateMinimize">
        </print-job-create>
      </v-card>
    </v-main>
  </v-app>
...
const printJobCreateMinimize = ref(false);
</script>
